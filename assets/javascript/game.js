const CrystalCollector = function() {
    ...
    this.collectCrystal = function(index) {
        ...
        if (currentSum < targetSum) {
            ...
            $("#outputMessage").html("Congratulations!<br>Click anywhere to continue.").css({"background-color": "#F8B195"});
            ...
            $("#outputMessage").html("You went over the target!<br>Click anywhere to continue.").css({"background-color": "red"});
